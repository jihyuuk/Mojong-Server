...
public class InIt {
    ...
    public void init() {
        ...
        list.add(new Category("기타1"));
        list.add(new Category("기타2"));
        ...
        em.persist(new Item(list.get(0), "불꽃스타", "50구 / 청색줄 / 매운맛약", 500));
        ...
        em.persist(new Item(list.get(1), "미인풋고추", "50구", 600));
        ...
        //파프리카
        em.persist(new Item(list.get(4), "파프리카(노랑)", "컵포트", 1500));
        em.persist(new Item(list.get(4), "파프리카(빨강)", "컵포트", 1500));
        em.persist(new Item(list.get(4), "파프리카(주황)", "컵포트", 1500));

        //호박
        em.persist(new Item(list.get(5), "애호박", "50구", 500));
        em.persist(new Item(list.get(5), "풋호박", "50구", 500));
        em.persist(new Item(list.get(5), "맷돌호박", "50구", 600));
        em.persist(new Item(list.get(5), "단호박", "50구", 500));
        em.persist(new Item(list.get(5), "보우짱", "32구", 2500));

        //토마토
        em.persist(new Item(list.get(6), "도태랑", "50구", 800));
        ...
        em.persist(new Item(list.get(8), "노각오이", "50구 / 녹색판", 400));
